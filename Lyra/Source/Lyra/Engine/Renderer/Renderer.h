...
namespace Lyra
{
	...
	public:
		...
		static void Submit(const Ref<Material>& material, const Scope<VertexArray>& vertexArray, const glm::mat4& modelMatrix = glm::mat4(1.0f), bool drawIndexed = true, RenderType renderType = RenderType::LR_OPAQUE);
